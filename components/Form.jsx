          ...
          <div className="bg-[#E3E3E3] w-full flex flex-col justify-center items-center p-8 rounded-2xl text-center">
            ...
            <form onSubmit={handleSubmit}>
              <label className="block mt-4 mb-4">
                <span className="bg-alpha text-white px-4 py-4 rounded-3xl cursor-pointer hover:bg-alpha/90 hover:translate-y-0.5 transition-all duration-300">
                  Upload Image
                </span>
                <input
                  type="file"
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                [&::-webkit-slider-thumb]:shadow-[0_0_0_4px_#292D32]
