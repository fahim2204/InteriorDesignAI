...
const BeforeAfterSlider = () => {
  ...
  const ImageList = [
    { before: "/assets/heroimg.png", after: "/assets/furniture-design-2.png" },
    { before: "/assets/heroimg.png", after: "/assets/furniture-design-3.png" },
    { before: "/assets/heroimg.png", after: "/assets/furniture-design-3.png" },
  ];
  ...
  return (
    <div className="text-alpha mx-auto max-w-7xl py-10 md:py-16 lg:py-24 px-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 p-4">
        <div className="h-full">
          <div className="bg-[#C3D3C8] p-8 px-12 rounded-3xl h-full flex flex-col pb-10 relative">
            <p className="text-alpha text-[16px] font-bold tracking-[0.25em] uppercase mb-3 font-alpha">
              Before & After
            </p>
